...
<br>
<br>
This VM is part of the `Oompa Loompa Task Force (OLTF)` Proxmox Resource Pool (see the Wonka homelab theme described in the [Ubuntu Server + Docker + Arcane](../homelab/ubuntu-docker-arcane.md) post). The runner VM is named `oltf-win11-runner`.
<br>
<br>
